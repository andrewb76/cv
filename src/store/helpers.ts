...
const JSONBIN_IAM_ID = process.env.VUE_APP_JSONBIN_IAM_ID || ''

const getBinJsonById = (id: string): Promise<Array<IProjectJson>> => {
...
const normalizeData = (id: string) => getBinJsonById(id).then(projectsFromJson)
...
export const getIam = () => getBinJsonById(JSONBIN_IAM_ID)